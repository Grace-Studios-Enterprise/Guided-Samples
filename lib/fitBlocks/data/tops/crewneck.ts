...
const relaxedBaseM: TopMeasurementSet = {
  consumer: {
    ...
    shoulderWidth: 19.0,  // slightly wider than tee to allow layering
    sleeveLength:  b.publishedMeasurementsAtM.sleeveLength, // 25.5
  },
  technical: {
    armhole:       10.5,
    bottomOpening: 20.5,  // ribbed hem band is slightly narrower than body
    neckOpening:   8.25,  // wider than tee, heavier rib
    sleeveOpening: 5.25,  // ribbed cuff
    cuffLength:    2.0,
    cuffOpening:   5.25,
    backLength:    28.75,
  },
...
const PLACEMENTS: GraphicPlacement[] = [
  { location: 'center_chest', xOffsetInches: 0, yOffsetInches: 5.0, maxWidthInches: 12, maxHeightInches: 12, widthGradePerSize: 0.5, notes: '5" from HPS to top of graphic. Fleece has more bulk — slightly lower placement.' },
  { location: 'left_chest',   xOffsetInches: -5, yOffsetInches: 5.0, maxWidthInches: 3.5, maxHeightInches: 3.5, widthGradePerSize: 0, notes: 'Logo/badge zone.' },
  { location: 'upper_back',   xOffsetInches: 0, yOffsetInches: 4.5, maxWidthInches: 14, maxHeightInches: 5, widthGradePerSize: 0.5, notes: 'Across back yoke.' },
  { location: 'center_back',  xOffsetInches: 0, yOffsetInches: 9.0, maxWidthInches: 14, maxHeightInches: 12, widthGradePerSize: 0.5, notes: 'Large back graphic.' },
]
...
export const crewneck: TopFitLibrary = {
  garmentType:   'crewneck',
  defaultFit:    'relaxed',
